...
function withinfam_pred(){
    ...
    python $snipar_path/fPGS.py $within_family_path/processed/fpgs/${EFFECT}_${PHENONAME} \
...
withinfam_pred ${within_family_path}/processed/sbayesr/bmi/dir/weights/meta_weights.snpRes "dir" "bmi"
withinfam_pred ${within_family_path}/processed/sbayesr/bmi/population/weights/meta_weights.snpRes "population" "bmi"