...
#     --phenofile /var/genetics/data/mcs/private/latest/raw/genotyped/NCDS_SFTP_1TB_1/imputed/phen/depression/pheno.pheno \
#     --pgsreg-r2

# python ${within_family_path}/scripts/fpgs/bootstrapest.py \
#     ${within_family_path}/processed/fpgs/depression/dirpop_ceoffratiodiff \
#     --pgsgroup1 /var/genetics/data/mcs/private/latest/processed/pgs/fpgs/depression/population_full.pgs.txt,/var/genetics/data/mcs/private/latest/processed/pgs/fpgs/depression/population_proband.pgs.txt \
#     --pgsgroup2 /var/genetics/data/mcs/private/latest/processed/pgs/fpgs/depression/direct_full.pgs.txt,/var/genetics/data/mcs/private/latest/processed/pgs/fpgs/depression/direct_proband.pgs.txt \
#     --phenofile /var/genetics/data/mcs/private/latest/raw/genotyped/NCDS_SFTP_1TB_1/imputed/phen/depression/pheno.pheno \
#     --pgsreg-r2 
