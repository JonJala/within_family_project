...
--merge-alleles ${merge_alleles} \
--signed-sumstats z_dir,0 --N-col dir_N --p dir_pval \
...
python ${ldsc_path}/munge_sumstats.py \
--sumstats /var/genetics/proj/within_family/within_family_project/scratch/meta_analysis_sampleoverlap/with_ea4.csv \
--merge-alleles ${merge_alleles} \
--signed-sumstats z_dir,0 --N-col dir_N --p dir_pval \
--out /var/genetics/proj/within_family/within_family_project/scratch/meta_analysis_sampleoverlap/with_ea4
...
python ${ldsc_path}/ldsc.py \
--h2 /var/genetics/proj/within_family/within_family_project/scratch/meta_analysis_sampleoverlap/with_ea4.sumstats.gz \
--ref-ld-chr ${eur_w_ld_chr} \
--w-ld-chr ${eur_w_ld_chr} \
--out /var/genetics/proj/within_family/within_family_project/scratch/meta_analysis_sampleoverlap/with_ea4
