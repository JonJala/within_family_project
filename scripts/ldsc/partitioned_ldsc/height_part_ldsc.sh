...
python ${ldscpath}/ldsc.py \
  ...
  --print-coefficients \
  --print-delete-vals \
  --out ${within_family_directory}/partitioned_ldsc/${pheno}/${effect}.baselineLD
...
python ${ldscpath}/ldsc.py \
  ...
  --print-coefficients \
  --print-delete-vals \
  --out ${within_family_directory}/partitioned_ldsc/${pheno}/${effect}.cahoy.1
...
python ${ldscpath}/ldsc.py \
  ...
  --print-coefficients \
  --print-delete-vals \
  --out ${within_family_directory}/partitioned_ldsc/${pheno}/${effect}.cahoy.2
...
python ${ldscpath}/ldsc.py \
  ...
  --print-coefficients \
  --print-delete-vals \
  --out ${within_family_directory}/partitioned_ldsc/${pheno}/${effect}.cahoy.3
...
python ${ldscpath}/ldsc.py \
  ...
  --print-coefficients \
  --print-delete-vals \
  --out ${within_family_directory}/partitioned_ldsc/${pheno}/${effect}.cahoy.1.control
...
python ${ldscpath}/ldsc.py \
  ...
  --print-coefficients \
  --print-delete-vals \
  --out ${within_family_directory}/partitioned_ldsc/${pheno}/${effect}.cahoy.2.control
...
python ${ldscpath}/ldsc.py \
  ...
  --print-coefficients \
  --print-delete-vals \
  --out ${within_family_directory}/partitioned_ldsc/${pheno}/${effect}.cahoy.3.control
