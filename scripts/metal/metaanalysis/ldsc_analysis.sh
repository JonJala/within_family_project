...
--out ${within_family_path}/results/metal_ldsc/ea_dir_pop
...
--ref-ld-chr ${eur_w_ld_chr} \
--w-ld-chr ${eur_w_ld_chr} \
--out ${within_family_path}/results/metal_ldsc/ea_dir_avgparental
...
--ref-ld-chr ${eur_w_ld_chr} \
--w-ld-chr ${eur_w_ld_chr} \
--out ${within_family_path}/results/metal_ldsc/bmi_dir_pop
...
--ref-ld-chr ${eur_w_ld_chr} \
--w-ld-chr ${eur_w_ld_chr} \
--out ${within_family_path}/results/metal_ldsc/bmi_dir_avgparental
...
--ref-ld-chr ${eur_w_ld_chr} \
--w-ld-chr ${eur_w_ld_chr} \
--out ${within_family_path}/results/metal_ldsc/bmi_ea_dir
...
--ref-ld-chr ${eur_w_ld_chr} \
--w-ld-chr ${eur_w_ld_chr} \
--out ${within_family_path}/results/metal_ldsc/bmi_ea_avgparental
...
--ref-ld-chr ${eur_w_ld_chr} \
--w-ld-chr ${eur_w_ld_chr} \
--out ${within_family_path}/results/metal_ldsc/bmi_ea_pop


echo "Calculating Genetic Correlation between EA pop with reference EA"
${ldscpath}/ldsc.py \
--rg ${within_family_path}/processed/metal_output/metal_pop_ea1_munged.sumstats.gz,${within_family_path}/ea_ref/GWAS_EA_excl23andMe.sumstats.gz \
--ref-ld-chr ${eur_w_ld_chr} \
--w-ld-chr ${eur_w_ld_chr} \
--out ${within_family_path}/results/metal_ldsc/ea_ref

echo "Calculating Genetic Correlation between BMI Pop and Reference BMI"
${ldscpath}/ldsc.py \
--rg ${within_family_path}/processed/metal_output/metal_pop_bmi1_munged.sumstats.gz,${within_family_path}/bmi_ref/Meta-analysis_Locke_et_al+UKBiobank_2018_UPDATED.sumstats.gz \
--ref-ld-chr ${eur_w_ld_chr} \
--w-ld-chr ${eur_w_ld_chr} \
--out ${within_family_path}/results/metal_ldsc/bmi_ref
