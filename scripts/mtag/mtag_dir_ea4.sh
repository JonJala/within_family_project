...
######################################################
# == MTAG with var cov from snipar ldsc estimator == #
######################################################

python ${mtag_path}/mtag.py \
    --sumstats ${within_family_path}/processed/mtag/inputs/ea_meta_dir.sumstats,${within_family_path}/processed/mtag/inputs/ea4_excl_ukb_gs_str.sumstats \
    --out ${within_family_path}/processed/mtag/dir_ea4_sldsc \
    --gencov_path ${within_family_path}/processed/package_output/ea/snipar_population.varcov.txt
