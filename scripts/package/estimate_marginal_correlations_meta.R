...
option_list = list(
  ...
  make_option(c("--avgparbeta"),  type="character", default="avg_parental_Beta", help="Name of avgparental beta col", metavar="character"),
  ...
  make_option(c("--avgparse"),  type="character", default="avg_parental_SE", help="Name avg parental se col", metavar="character"),
