...
the reader will try and infer the chromosome number from the file name.''')
    ...
    if args.normfiles:
        ...
        files = [file for file in files if "clean." in file or "CLEANED." in file or "munged_ecf" in file or "out." in file or "refldsc" in file] # only files that are generated by easyQC. we don't want to delete files from the correlation meta-analysis
