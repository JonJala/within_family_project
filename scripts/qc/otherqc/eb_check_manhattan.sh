...
--chr "CHR" --rsID "SNP" --bpos "pos" --p "PVAL_direct" --z "z_direct" \
--pathout "${within_family_path}/processed/qc/estonian_biobank/ea/manhattan_pop.png"
...
--meta_cleaned "/var/genetics/proj/within_family/within_family_project/processed/qc/estonian_biobank/ea/controls/CLEANED.out.gz" \
--title "EA \ Population \ Effects \ EB" \
--chr "chromosome" --rsID "SNP" --bpos "pos" --p "PVAL_direct" --z "z_direct" \
--pathout "${within_family_path}/processed/qc/estonian_biobank/ea/controls/manhattan_pop.png"
