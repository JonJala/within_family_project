...
# ============= Execution ============= #
run_pgi "${within_family_path}/processed/package_output/aafb/meta.hm3.sumstats.gz" "direct" "aafb" "mcs"
run_pgi "${within_family_path}/processed/package_output/aafb/meta.hm3.sumstats.gz" "population" "aafb" "mcs"