...
# ============= Execution ============= #
run_pgi "${within_family_path}/processed/package_output/adhd/meta.hm3.sumstats.gz" "direct" "adhd" "mcs"
run_pgi "${within_family_path}/processed/package_output/adhd/meta.hm3.sumstats.gz" "population" "adhd" "mcs"