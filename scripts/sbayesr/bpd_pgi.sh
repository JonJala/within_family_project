...
# ============= Execution ============= #
run_pgi "${within_family_path}/processed/package_output/bpd/meta.hm3.sumstats.gz" "direct" "bpd" "mcs"
run_pgi "${within_family_path}/processed/package_output/bpd/meta.hm3.sumstats.gz" "population" "bpd" "mcs"