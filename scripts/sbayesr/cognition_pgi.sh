...
# ============= Execution ============= #
run_pgi "${within_family_path}/processed/package_output/cog/meta.sumstats.gz" "direct" "cognition" "mcs"
run_pgi "${within_family_path}/processed/package_output/cog/meta.sumstats.gz" "population" "cognition" "mcs"