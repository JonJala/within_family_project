...
# ============= Execution ============= #
run_pgi "${within_family_path}/processed/package_output/cpd/meta.hm3.sumstats.gz" "direct" "cpd" "mcs"
run_pgi "${within_family_path}/processed/package_output/cpd/meta.hm3.sumstats.gz" "population" "cpd" "mcs"