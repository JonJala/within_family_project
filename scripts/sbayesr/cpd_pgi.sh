...
# ============= Execution ============= #
run_pgi "${within_family_path}/processed/package_output/cpd/meta_noukb.hm3.sumstats.gz" "direct" "cpd" "ukb"
run_pgi "${within_family_path}/processed/package_output/cpd/meta_noukb.hm3.sumstats.gz" "population" "cpd" "ukb"