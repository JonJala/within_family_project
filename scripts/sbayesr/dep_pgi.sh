...
# ============= Execution ============= #
run_pgi "${within_family_path}/processed/package_output/depression/meta.sumstats" "direct" "depression"
run_pgi "${within_family_path}/processed/package_output/depression/meta.sumstats" "population" "depression"