...
# ============= Execution ============= #
run_pgi "${within_family_path}/processed/package_output/dpw/meta.hm3.sumstats.gz" "direct" "dpw" "mcs"
run_pgi "${within_family_path}/processed/package_output/dpw/meta.hm3.sumstats.gz" "population" "dpw" "mcs"