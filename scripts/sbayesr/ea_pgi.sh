...
# ============= Execution ============= #
# run_pgi "${within_family_path}/processed/package_output/ea/ea_meta_analysis_newqc.csv" "dir" "ea"
# run_pgi "${within_family_path}/processed/package_output/ea/ea_meta_analysis_newqc.csv" "population" "ea"
