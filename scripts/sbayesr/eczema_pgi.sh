...
# ============= Execution ============= #
run_pgi "${within_family_path}/processed/package_output/eczema/meta.hm3.sumstats.gz" "direct" "eczema" "mcs"
run_pgi "${within_family_path}/processed/package_output/eczema/meta.hm3.sumstats.gz" "population" "eczema" "mcs"