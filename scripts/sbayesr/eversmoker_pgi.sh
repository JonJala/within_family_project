...
# ============= Execution ============= #
run_pgi "${within_family_path}/processed/package_output/eversmoker/meta.sumstats.gz" "direct" "eversmoker"
run_pgi "${within_family_path}/processed/package_output/eversmoker/meta.sumstats.gz" "population" "eversmoker"
