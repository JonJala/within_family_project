...
# ============= Execution ============= #
run_pgi "${within_family_path}/processed/package_output/fev/meta_noukb.hm3.sumstats.gz" "direct" "fev" "ukb"
run_pgi "${within_family_path}/processed/package_output/fev/meta_noukb.hm3.sumstats.gz" "population" "fev" "ukb"