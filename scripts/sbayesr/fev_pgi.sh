...
# ============= Execution ============= #
run_pgi "${within_family_path}/processed/package_output/fev/meta.hm3.sumstats.gz" "direct" "fev" "mcs"
run_pgi "${within_family_path}/processed/package_output/fev/meta.hm3.sumstats.gz" "population" "fev" "mcs"