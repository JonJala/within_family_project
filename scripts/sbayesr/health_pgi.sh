...
# ============= Execution ============= #
run_pgi "${within_family_path}/processed/package_output/health/meta.hm3.sumstats.gz" "direct" "health" "mcs"
run_pgi "${within_family_path}/processed/package_output/health/meta.hm3.sumstats.gz" "population" "health" "mcs"