...
# ============= Execution ============= #
run_pgi "${within_family_path}/processed/package_output/height/meta.sumstats" "direct" "height"
run_pgi "${within_family_path}/processed/package_output/height/meta.sumstats" "population" "height"
