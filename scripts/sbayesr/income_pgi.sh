...
# ============= Execution ============= #
run_pgi "${within_family_path}/processed/package_output/income/meta.hm3.sumstats.gz" "direct" "income" "mcs"
run_pgi "${within_family_path}/processed/package_output/income/meta.hm3.sumstats.gz" "population" "income" "mcs"