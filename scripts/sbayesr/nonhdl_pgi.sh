...
# ============= Execution ============= #
run_pgi "${within_family_path}/processed/package_output/nonhdl/meta.hm3.sumstats.gz" "direct" "nonhdl" "mcs"
run_pgi "${within_family_path}/processed/package_output/nonhdl/meta.hm3.sumstats.gz" "population" "nonhdl" "mcs"