...
# ============= Execution ============= #
run_pgi "${within_family_path}/processed/package_output/swb/meta.hm3.sumstats.gz" "direct" "swb" "mcs"
run_pgi "${within_family_path}/processed/package_output/swb/meta.hm3.sumstats.gz" "population" "swb" "mcs"