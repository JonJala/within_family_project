...
pheno = "aafb"
all_cohorts = ["ukb", "estonian_biobank", "hunt", "qimr", "finngen", "ipsych"]
...
corr.get_correlations(cohort = "ipsych", processed_ss = "/disk/genetics/data/ipsych/public/v2/processed/sumstats/sumstats_age_fb_export_plinkfiltered", pheno = pheno, chrposid = True, format = False, avg_ntc = True)
