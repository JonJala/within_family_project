...
${ldscpath}/ldsc.py \
--rg ${within_family_path}/processed/package_output/aafb/populationmunged.sumstats.gz,${within_family_path}/processed/reference_samples/ht_ref/Meta-analysis_Wood_et_al+UKBiobank_2018.sumstats.gz \
...
${ldscpath}/ldsc.py \
--rg ${within_family_path}/processed/package_output/aafb/directmunged.sumstats.gz,${within_family_path}/processed/reference_samples/ht_ref/Meta-analysis_Wood_et_al+UKBiobank_2018.sumstats.gz \
--ref-ld-chr ${eur_w_ld_chr} \
--w-ld-chr ${eur_w_ld_chr} \
...
/var/genetics/proj/within_family/within_family_project/snipar/snipar/scripts/correlate.py /var/genetics/proj/within_family/within_family_project/processed/package_output/aafb/meta.nfilter \
