...
corr.get_correlations(cohort = "dutch_twin", raw_ss = "/var/genetics/data/dutch_twin/public/latest/raw/sumstats/fgwas/BMI/NTR_BMI_CHR*.sumstats.hdf5", processed_ss = "/var/genetics/data/dutch_twin/public/latest/processed/sumstats/fgwas/Height/gz/NTR_Height_CHR@", pheno = pheno, chrposid = True, format = True, avg_ntc = False)
...
corr.get_correlations(cohort = "botnia", processed_ss = "/var/genetics/data/botnia_fam/private/latest/processed/sumstats/fgwas/6/chr_@", pheno = pheno, chrposid = True, format = False, avg_ntc = True)
