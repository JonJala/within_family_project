...
--sumstats ${within_family_path}/processed/package_output/bmi/meta_adj_se.sumstats.gz \
...
${ldscpath}/ldsc.py \
--rg ${within_family_path}/processed/package_output/bmi/populationmunged.sumstats.gz,${within_family_path}/processed/package_output/bmi/directmunged.sumstats.gz \
--ref-ld-chr ${eur_w_ld_chr} \
--w-ld-chr ${eur_w_ld_chr} \
...
/var/genetics/proj/within_family/snipar_simulate/snipar/scripts/correlate.py  /var/genetics/proj/within_family/within_family_project/processed/package_output/bmi/meta_adj_se \
