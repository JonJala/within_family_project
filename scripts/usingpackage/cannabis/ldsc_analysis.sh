...
${ldscpath}/munge_sumstats.py \
--sumstats ${within_family_path}/processed/package_output/cannabis/meta.nfilter.sumstats.gz \
--out ${within_family_path}/processed/package_output/cannabis/ntcmunged \
...
${ldscpath}/ldsc.py \
--rg ${within_family_path}/processed/package_output/cannabis/ntcmunged.sumstats.gz,${within_family_path}/processed/package_output/cannabis/directmunged.sumstats.gz \
--ref-ld-chr ${eur_w_ld_chr} \
--w-ld-chr ${eur_w_ld_chr} \
--out ${within_family_path}/processed/package_output/cannabis/direct_avgNTC
