...
${ldscpath}/munge_sumstats.py \
--sumstats ${within_family_path}/processed/package_output/copd/meta.nfilter.sumstats.gz \
--out ${within_family_path}/processed/package_output/copd/ntcmunged \
...
${ldscpath}/ldsc.py \
--rg ${within_family_path}/processed/package_output/copd/ntcmunged.sumstats.gz,${within_family_path}/processed/package_output/copd/directmunged.sumstats.gz \
--ref-ld-chr ${eur_w_ld_chr} \
--w-ld-chr ${eur_w_ld_chr} \
--out ${within_family_path}/processed/package_output/copd/direct_avgNTC
