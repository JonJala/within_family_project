...
pheno = "depression"
all_cohorts = ["estonian_biobank", "ukb", "geisinger", "dutch_twin", "finngen", "ipsych"]
...
corr.get_correlations(cohort = "ipsych", processed_ss = "/disk/genetics/data/ipsych/public/v2/processed/sumstats/sumstats_depression_export_plinkfiltered", pheno = pheno, chrposid = True, format = False, avg_ntc = True)
