...
refsample="/var/genetics/proj/within_family/within_family_project/processed/reference_samples/depression_ref/depression_ref.sumstats.gz"
...
${ldscpath}/ldsc.py \
--rg ${within_family_path}/processed/package_output/depression/ntcmunged.sumstats.gz,${within_family_path}/processed/package_output/depression/directmunged.sumstats.gz \
--ref-ld-chr ${eur_w_ld_chr} \
--w-ld-chr ${eur_w_ld_chr} \
--out ${within_family_path}/processed/package_output/depression/direct_avgNTC
