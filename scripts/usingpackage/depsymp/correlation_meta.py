...
corr.get_correlations(cohort = "qimr", raw_ss = "/var/genetics/data/qimr/private/v1/raw/pgs/QIMR_FamilyGWAS/Depression_Symptoms/Depression_Symptoms_Chr*.sumstats.hdf5", processed_ss = "/var/genetics/data/qimr/private/v1/processed/pgs/QIMR_FamilyGWAS/Depression_Symptoms/gz/Depression_Symptoms_Chr@", pheno = pheno, chrposid = True, format = True, avg_ntc = False)
