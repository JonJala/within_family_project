...
${ldscpath}/ldsc.py \
--rg ${within_family_path}/processed/package_output/ea/eb_nocontrol/pop_munge.sumstats.gz,${within_family_path}/processed/reference_samples/ea_ref/ea_ref.sumstats.gz \
