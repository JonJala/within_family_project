...
${ldscpath}/ldsc.py \
--rg ${within_family_path}/processed/package_output/ea/meta_analysis_new_qc_dir.sumstats.gz,${within_family_path}/processed/metal_output/metal_dir_ea1_munged.sumstats.gz \
--ref-ld-chr ${eur_w_ld_chr} \
--w-ld-chr ${eur_w_ld_chr} \
