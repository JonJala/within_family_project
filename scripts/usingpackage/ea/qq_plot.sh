...
python ${ssgac_path}/plotting/qqplot.py \
--meta "${within_family_path}/processed/package_output/ea/ea_meta_analysis_ea4.sumstats" \
--title "EA Direct Effects" \
--p "direct_pval" --z "direct_z" \
--lambda_xpos 3 --lambda_ypos 5 \
--out "${within_family_path}/processed/package_output/ea/qq_dir_wea4.png"
...
--p "population_pval" --z "population_z" \
--lambda_xpos 3 --lambda_ypos 5 \
--out "${within_family_path}/processed/package_output/ea/qq_pop_wea4.png"