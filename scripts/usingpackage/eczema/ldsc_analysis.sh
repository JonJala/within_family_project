...
refsample="/var/genetics/proj/within_family/within_family_project/processed/reference_samples/eczema_ref/eczema_ref.sumstats.gz"

source /disk/genetics/pub/python_env/anaconda2/bin/activate /disk/genetics/pub/python_env/anaconda2/envs/ldsc

echo "Munging!!"
${ldscpath}/munge_sumstats.py \
--sumstats ${within_family_path}/processed/package_output/eczema/meta.nfilter.sumstats.gz \
--out ${within_family_path}/processed/package_output/eczema/populationmunged \
--N-col population_N --p population_pval --signed-sumstats population_z,0 \
--n-min 1.0

${ldscpath}/munge_sumstats.py \
--sumstats ${within_family_path}/processed/package_output/eczema/meta.nfilter.sumstats.gz \
--out ${within_family_path}/processed/package_output/eczema/directmunged \
--N-col direct_N --p direct_pval --signed-sumstats direct_z,0 \
--n-min 1.0

${ldscpath}/munge_sumstats.py \
--sumstats ${within_family_path}/processed/package_output/eczema/meta.nfilter.sumstats.gz \
--out ${within_family_path}/processed/package_output/eczema/ntcmunged \
...
${ldscpath}/ldsc.py \
--rg ${within_family_path}/processed/package_output/eczema/ntcmunged.sumstats.gz,${within_family_path}/processed/package_output/eczema/directmunged.sumstats.gz \
--ref-ld-chr ${eur_w_ld_chr} \
--w-ld-chr ${eur_w_ld_chr} \
--out ${within_family_path}/processed/package_output/eczema/direct_avgNTC

${ldscpath}/ldsc.py \
--h2 ${within_family_path}/processed/package_output/eczema/directmunged.sumstats.gz \
--ref-ld-chr ${eur_w_ld_chr} \
--w-ld-chr ${eur_w_ld_chr} \
--out ${within_family_path}/processed/package_output/eczema/direct_h2

${ldscpath}/ldsc.py \
--h2 ${within_family_path}/processed/package_output/eczema/populationmunged.sumstats.gz \
--ref-ld-chr ${eur_w_ld_chr} \
--w-ld-chr ${eur_w_ld_chr} \
--out ${within_family_path}/processed/package_output/eczema/population_h2


# Changing env
source /var/genetics/proj/within_family/snipar_venv/bin/activate
/var/genetics/proj/within_family/snipar_simulate/snipar/scripts/correlate.py /var/genetics/proj/within_family/within_family_project/processed/package_output/eczema/meta.nfilter \
/var/genetics/proj/within_family/within_family_project/processed/package_output/eczema/marginal \
