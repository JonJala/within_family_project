...
python "${sniparpath}/ldsc_reg/run_estimates.py" \
        "${within_family_path}/notebooks/creating_package/hdl/meta_analysis_pop.sumstats.hdf5" \
        -ldsc "${eur_w_ld_chr}/*[0-9].l2.ldscore.gz" \
        -e "full" \
        -bim_bp 2 -bim_a1 3 -bim_a2 4 \
        -maf 1 \
        -l "${within_family_path}/notebooks/creating_package/hdl/snipar_pop.log"


python "${sniparpath}/ldsc_reg/run_estimates.py" \
        "${within_family_path}/notebooks/creating_package/hdl/meta_analysis_avgpar.sumstats.hdf5" \
        -ldsc "${eur_w_ld_chr}/*[0-9].l2.ldscore.gz" \
        -e "full" \
        -bim_bp 2 -bim_a1 3 -bim_a2 4 \
        -maf 1 \
        -l "${within_family_path}/notebooks/creating_package/hdl/snipar_avgpar.log"
