...
${ldscpath}/munge_sumstats.py \
--sumstats ${within_family_path}/processed/package_output/health/meta.nfilter.sumstats.gz \
--out ${within_family_path}/processed/package_output/health/ntcmunged \
...
${ldscpath}/ldsc.py \
--rg ${within_family_path}/processed/package_output/health/ntcmunged.sumstats.gz,${within_family_path}/processed/package_output/health/directmunged.sumstats.gz \
--ref-ld-chr ${eur_w_ld_chr} \
--w-ld-chr ${eur_w_ld_chr} \
--out ${within_family_path}/processed/package_output/health/direct_avgNTC
