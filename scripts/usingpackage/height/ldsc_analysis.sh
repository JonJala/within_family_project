...
--N-col wt_2 --p pval_2 --signed-sumstats z_2,0 \
...
--N-col wt_1 --p pval_1 --signed-sumstats z_1,0 \
--merge-alleles ${hm3snps} \
--n-min 1.0

echo "Calcualting RG of population effect with reference sample"
# ${ldscpath}/ldsc.py \
# --rg ${within_family_path}/processed/package_output/height_meta_dir.sumstats.gz,${within_family_path}/processed/ea_ref/GWAS_EA_excl23andMe.sumstats.gz \
# --ref-ld-chr ${eur_w_ld_chr} \
# --w-ld-chr ${eur_w_ld_chr} \
# --out ${within_family_path}/notebooks/creating_package/ea/ea_reference_sample
...
# --intercept-gencov 0.6357058584062969,0.6357058584062969