...
--sumstats ${within_family_path}/processed/package_output/height/meta.sumstats.gz \
...
/var/genetics/proj/within_family/snipar_simulate/snipar/scripts/correlate.py /var/genetics/proj/within_family/within_family_project/processed/package_output/height/meta \
