...
refsample="/var/genetics/proj/within_family/within_family_project/processed/reference_samples/migraine_ref/migraine_ref.sumstats.gz"
...
${ldscpath}/munge_sumstats.py \
--sumstats ${within_family_path}/processed/package_output/migraine/meta.nfilter.sumstats.gz \
--out ${within_family_path}/processed/package_output/migraine/ntcmunged \
...
${ldscpath}/ldsc.py \
--rg ${within_family_path}/processed/package_output/migraine/ntcmunged.sumstats.gz,${within_family_path}/processed/package_output/migraine/directmunged.sumstats.gz \
--ref-ld-chr ${eur_w_ld_chr} \
--w-ld-chr ${eur_w_ld_chr} \
--out ${within_family_path}/processed/package_output/migraine/direct_avgNTC
