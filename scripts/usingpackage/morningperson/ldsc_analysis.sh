...
${ldscpath}/munge_sumstats.py \
--sumstats ${within_family_path}/processed/package_output/morningperson/meta.nfilter.sumstats.gz \
--out ${within_family_path}/processed/package_output/morningperson/ntcmunged \
...
${ldscpath}/ldsc.py \
--rg ${within_family_path}/processed/package_output/morningperson/populationmunged.sumstats.gz,${within_family_path}/processed/package_output/morningperson/directmunged.sumstats.gz \
--ref-ld-chr ${eur_w_ld_chr} \
--w-ld-chr ${eur_w_ld_chr} \
--out ${within_family_path}/processed/package_output/morningperson/direct_population

echo "Calculating RG of avg NTC with direct effect"
${ldscpath}/ldsc.py \
--rg ${within_family_path}/processed/package_output/morningperson/ntcmunged.sumstats.gz,${within_family_path}/processed/package_output/morningperson/directmunged.sumstats.gz \
--ref-ld-chr ${eur_w_ld_chr} \
--w-ld-chr ${eur_w_ld_chr} \
--out ${within_family_path}/processed/package_output/morningperson/direct_avgNTC
